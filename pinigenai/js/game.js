...
function userSelect() {
    ...
    gameConfig.label2 = new PIXI.Text("Naujas žaidėjas", labelStyle);
...
function backToUniverse() {
    ...
    $(".mononameinput").val("");
    $(".mononameinput").hide();
    if (gameConfig.startupNextBtn && gameConfig.startupNextBtn.parent !== null) {
...
function blockHover() {
    if (this.blockWidth) {
        TweenMax.to(this, 0.35, {
            pixi: {
                width: this.blockWidth * 1.05,
                height: this.blockHeight * 1.05
            },
            ease: Power2.easeIn
        });
    } else {
...
function setupMonoBG() {
    ...
    var gameBG = PIXI.Sprite.from('images/monopoly/monoGameCityWinter.png');
    if(false){
...
function endMonth() {
    ...
    //subtotal
    gameConfig.eventContainer.addChild(createMonoRow("Viso", 2, totalAmount, xPos, yPos));
    yPos += 50;
